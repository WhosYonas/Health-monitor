            ...
            <div className="min-h-screen h-lwh w-[70%]">
                <div className="bg-teal-700 p-5 m-2 rounded-2xl space-y-2 h-full overflow-hidden">
                    <div className="grid grid-cols-3 w-full items-center">
                        <h1 className="text-white text-2xl font-bold text-center h-[50px] justify-self-center col-2"> Patients: </h1>
                        <Link href="/addpatient" className="justify-self-end col-3">
                            <button className="bg-amber-50 p-3 rounded-2xl font-semibold cursor-pointer">Add Patient</button>
                        </Link>
                    </div>
