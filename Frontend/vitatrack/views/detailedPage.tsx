...
function HealthCard({label, value, unit, loading, onClick}: HealthCardProps){ 
    return(
        <button className="flex flex-col justify-center items-center rounded-xl border border-black-300 bg-rose-100 p-6 cursor-pointer" onClick={onClick}>
...
export function DetailedPage({healthData,loading, errorMessage}: DetailedPageProps) {
    ...
    return (
        <div className=" min-h-screen py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-950 via-teal-950 to-cyan-900">
            ...
            <div className="mt-10">
                ...
                These values are collected from your connected device and updated
                in real time. Contact your healthcare provider if any readings are
